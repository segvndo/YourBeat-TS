  ...
  return (
    <div className="box-content h-115 w-64 pt-4">
      <div className={`box-content h-96 w-64 p-4 flex flex-col items-center font-sans rounded-xl ${mainBackgroundColour}`}>
        ...
        <div className="box-content h-96 w-72 rounded-xl bg-green-800 text-yellow-50 font-sans mb-4 font-semibold text-3xl text-center pt-2">
          
          {title}
          
        <div className="flex-grow bg-gray-800 border-green-500 border-8 rounded-xl p-4 pb-60 text-lg">
